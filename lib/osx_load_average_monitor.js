...
var metrics = [];
metrics['load1min'] =  { retrieveMetric: 1, id: '77:Load 1min Avg:4',  get: function(t) { return parseFloat(t[7], 10); } };
metrics['load5min'] =  { retrieveMetric: 1, id: '199:Load 5min Avg:4', get: function(t) { return parseFloat(t[8], 10); } };
metrics['load15min'] = { retrieveMetric: 1, id: '59:Load 15min Avg:4', get: function(t) { return parseFloat(t[9], 10); } };
